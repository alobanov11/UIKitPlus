...
extension GestureRecognizerable {
    ...
    @discardableResult
    public func cancelsTouchesInView(_ binding: UISwift.State<Bool>) -> Self {
    ...
    @discardableResult
    public func delaysTouchesBegan(_ binding: UISwift.State<Bool>) -> Self {
    ...
    @discardableResult
    public func delaysTouchesEnded(_ binding: UISwift.State<Bool>) -> Self {
    ...
    @discardableResult
    public func requiresExclusiveTouchType(_ binding: UISwift.State<Bool>) -> Self {
