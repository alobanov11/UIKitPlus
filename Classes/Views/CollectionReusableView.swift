...
open class UCollectionReusableView: UICollectionReusableView, AnyDeclarativeProtocol, DeclarativeProtocolInternal, Supplementable {
	public var declarativeView: UCollectionReusableView { self }
	public lazy var properties = Properties<UCollectionReusableView>()
